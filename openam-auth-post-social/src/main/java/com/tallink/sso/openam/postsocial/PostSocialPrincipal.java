...
public class PostSocialPrincipal implements Principal, Serializable {
    private final static String COLON = " : ";

    private final String name;

    public PostSocialPrincipal(String name) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PostSocialPrincipal)) {
            return false;
        }
        PostSocialPrincipal that = (PostSocialPrincipal) o;
